...
impl Component for Pomodoro {
    ...
    fn create(ctx: &Context<Self>) -> Self {
        let standalone_handle =
            Interval::new(10, || console::debug!("Example of standalone callback."));
        ...
        Self {
            time: Pomodoro::get_current_time(),
            message: Vec::new(),
    ...
    fn update(&mut self, ctx: &Context<Self>, msg: Self::Message) -> bool {
        match msg {
            ...
            Msg::Cancel => {
                ...
                self.messages.clear();
                console::clear!();
                self.messages.push("Timer cancelled!");
                true
            }
            ...
            Msg::UpdateTime => {
                self.time = Pomodoro::get_current_time();
                true
            }
